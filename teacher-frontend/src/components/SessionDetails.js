...
{sessionDetails.topics.includes('Resistors in Parallel') && (
  <div className="topic-details-content">
    ...
    <h4>Summary:</h4>
    <p>
      Recap the key points discussed during the session. Emphasize the differences between series and parallel connections
      of resistors. Highlight the significance of understanding resistors in parallel in practical applications.
    </p>
    <h4>Homework:</h4>
    <ul>
