...
const SchoolCalendar = () => {
  ...
  const handleGenerateLessonPlan = () => {
    // Navigate to the lesson plan form, passing the selected school ID
    navigate(`/lesson-plan?schoolId=${selectedSchool}`);
  };
      ...
      <div className="calendar">
        {selectedSchool ? (
          <>
            ...
            {/* Add the Generate Lesson Plan Button */}
            <button
              className="generate-lesson-plan-btn"
